#Modified from:  https://github.com/Azure/azure-iot-sdk-python/blob/main/samples/async-hub-scenarios/recurring_telemetry.py
...
def main():
    ...
    conn_str = <Insert-Your-Connection-String-Here>
